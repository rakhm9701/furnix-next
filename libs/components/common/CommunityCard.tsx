...
const CommunityCard = (props: CommunityCardProps) => {
	...
	if (device === 'mobile') {
		...
		return (
			<Stack
				sx={{ width: size === 'small' ? '285px' : '300px' }}
			...
			>
				...
				<Stack className={'top-box'}>
					...
					<Stack className={'comment-box'}>
						<Typography className={'comment-box'}>Comment: {boardArticle?.articleComments}</Typography>
					</Stack>
					<Stack className={'title-box'}>
						<Typography className="title">Title: {boardArticle?.articleTitle}</Typography>
					</Stack>
				</Stack>
