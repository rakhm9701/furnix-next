...
export const READ_NOTIFICATION = gql`
	mutation NotificationTargetProduct($input: String!) {
		notificationTargetProduct(input: $input) {
			_id
			notificationType
			notificationStatus
			notificationGroup
...
export const READ_ALL_NOTIFICATION = gql`
	mutation NotificationsTargetProduct($input: String!) {
		notificationsTargetProduct(input: $input)
	}
`;
